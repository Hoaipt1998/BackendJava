...
<head>  
    <meta charset="UTF-8">  
    <title>Result Repair Log</title>  
    <link type="text/css" rel="stylesheet" href="bootstrap.min.css" th:href="@{bootstrap.min.css}"/>  
</head>  
<body>  
<div class="col-3"></div>  
<div class="container col-6">  
    <h1>Device Repairing Result</h1>  
    <div class="col-md-auto">  
        <form th:object="${repairLog}" th:action="@{save}" action="saveResultRepairLog" modelAttribute="repairLog" method="post"> 
         	<div>  
                ...
                <input type="hidden" th:field="*{id}" class="form-control"  name="id" placeholder="id" value="${repairLog.id}"/> 
            </div>  
            <div style="clear: both; display: block; height: 10px"></div>
            <div>  
                <label th:text="inDate" th:for="inDate"></label>  
                <fmt:formatDate value="${repairLog.inDate }" pattern="dd/MM/yyyy" var="inDate"/>
