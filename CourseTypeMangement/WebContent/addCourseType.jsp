...
<body>
<form method="POST" action="AddCourseTypeServlet">
<table border="1" width="100%" id="table1" cellspacing="0" cellpadding="0">
	<tr>
		<td colspan="2">
		<p align="center"><b><font face="Tahoma" size="2">Add Course Type</font></b></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="text" name="description"  size="20"></font></td>
	</tr>
	<tr>
		<td width="20%">&nbsp;</td>
		<td width="79%"><font face="Tahoma">
