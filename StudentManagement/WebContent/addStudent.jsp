...
<table border="1" width="100%" id="table1" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td width="20%" align="right"><font face="Tahoma" size="2"><b>Gender:</b></font></td>
		<td width="79%" >
			<font face="Tahoma">
			<input name="gender"><font size="2">
			</font></font>
		</td>
	</tr>
	
	<tr>
		<td width="20%" align="right"><font face="Tahoma" size="2"><b>Email:</b></font></td>
		<td width="79%" >
			<font face="Tahoma">
			<input name="email"><font size="2">
			</font></font>
		</td>
	</tr>
	
	<tr>
		<td width="20%" align="right"><font face="Tahoma" size="2"><b>Phone Number:</b></font></td>
		<td width="79%" >
			<font face="Tahoma">
			<input name="phoneNumber"><font size="2">
			</font></font>
		</td>
	</tr>
