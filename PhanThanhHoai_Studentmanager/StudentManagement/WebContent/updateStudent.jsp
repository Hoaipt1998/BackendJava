...
<table border="1" width="100%" id="table1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="79%" >
			...
			<input name="lastName" value=<%=student.getLastName() %>><font size="2">
			</font></font>
		</td>
	</tr>
	...
	<tr>
		...
		Gender:</b></font></td>
		<td width="79%"><font face="Tahoma">
		<input type="text" name="gender" value="<%=student.getGender()%>"  size="20"></font></td>
	</tr>
	<tr>
		<td width="20%" align="right"><font face="Tahoma" size="2"><b>
		Email</b></font></td>
		<td width="79%"><font face="Tahoma">
		<input type="text" name="email" value="<%=student.getEmail()%>"  size="20"></font></td>
	</tr>
	<tr>
		<td width="20%" align="right"><font face="Tahoma" size="2"><b>
		Phone Number:</b></font></td>
		<td width="79%"><font face="Tahoma">
		<input type="text" name="phoneNumber" value="<%=student.getPhoneNumber()%>"  size="20"></font></td>
	</tr>
