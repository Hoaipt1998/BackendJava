...
<div class="container col-6">  
    ...
    <div class="col-md-auto">  
        <form th:object="${person}" th:action="@{save}" action="savePerson" modelAttribute="person" method="post">  
       		 <div>  
                <label th:text="ID" th:for="ID"></label>  
                <input type="text" th:field="*{ID}" class="form-control"  name="ID" placeholder="ID"/>  
            </div>  
