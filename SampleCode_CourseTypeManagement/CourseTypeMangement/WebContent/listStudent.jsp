...
<table border="1" width="100%" id="table1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="40%" align="center"><b><font face="Tahoma" size="2">Code</font></b></td>
...
%>				
	...
	<tr>
		<td>&nbsp;<%=no %></td>
		<td>&nbsp;<a href="updateStudent.jsp?id=<%=rs.getString("id")%>"> <%=rs.getString("code") %></a></td>
		<td>&nbsp;<%=rs.getString("firstName")!=null?rs.getString("firstName"):"" %></td>
		<td>&nbsp;<%=rs.getString("lastName")!=null?rs.getString("lastName"):"" %></td>
